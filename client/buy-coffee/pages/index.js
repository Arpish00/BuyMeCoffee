...
import abi from '../contract-json/BuyMeCoffee.json';
...
export default function Home() {
  ...
  const getMemos = async () => {
    try {
      ...
      if (ethereum) {
        ...
        const memos = await buyMeCoffee.showMemos();
        console.log("fetched!");
        setMemos(memos);
      } else {
  ...
  useEffect(() => {
    ...
    // us a new memo.
    const onnewRaise = (from, timestamp, name, message) => {
    ...
    if (ethereum) {
      ...
      buyMeACoffee.on("newRaise", onnewRaise);
    }
  
    return () => {
      if (buyMeACoffee) {
        buyMeACoffee.off("newRaise", onnewRaise);
      }
    }
  }, []);
  ...
  return (
    <div className={styles.container}>
      ...
      <Head>
        <title>Buy Arpish a Coffee!</title>
